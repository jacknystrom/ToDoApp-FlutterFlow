...
class _LoginWidgetState extends State<LoginWidget>
  ...
  void initState() {
    ...
    _model.signUpConfrimPasswordTextController ??= TextEditingController();
    _model.signUpConfrimPasswordFocusNode ??= FocusNode();
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    ...
                                    child: TextFormField(
                                      controller: _model
                                          .signUpConfrimPasswordTextController,
                                      focusNode:
                                          _model.signUpConfrimPasswordFocusNode,
                                      autofocus: false,
                                      textInputAction: TextInputAction.done,
                                      obscureText: !_model
                                          .signUpConfrimPasswordVisibility,
                                      decoration: InputDecoration(
                                        isDense: true,
                                        labelStyle: FlutterFlowTheme.of(context)
                                            .labelMedium
                                        ...
                                        suffixIcon: InkWell(
                                          ...
                                          focusNode:
                                              FocusNode(skipTraversal: true),
                                          child: Icon(
                                            _model.signUpConfrimPasswordVisibility
                                                ? Icons.visibility_outlined
                                                : Icons.visibility_off_outlined,
                                            size: 24.0,
                                          ),
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          ...
                          if (_model.signUpPasswordTextController.text !=
                              _model.signUpConfrimPasswordTextController.text) {
